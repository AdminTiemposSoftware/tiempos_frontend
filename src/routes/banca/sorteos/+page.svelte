<script lang="ts">
 ...
 /*
  OPCION DE CONSOLIDADO Y DETALLADO
  DE DECHA A FECHA O DE UN DIA
  POR SORTEO QUE SE AGRUPE POR SORTEO
  ...
  PREMIO
  DEVOLUCION
  PREMIO DE LA DEVOLUCION(ESTO PUEDE SER IGUAL O DIFERENTE)
  NETO =  VENTA - COMISION - PREMIO - DEVOLUCION

  VISTO EN EL OTRO-----
  IMPORTE ES VENTA

  NO LE GUSTA QUE NO SE VEN TODOS LOS SORTEOS A LA VEZ
  PROHIBIDOS QUEDO CONFUSO

  DARLE LA HABILIDAD DE DESACTIVAR SORTEOS
  EN CASO QUE SE DESACTIVE NO DEBE SALIR EN REPORTES
